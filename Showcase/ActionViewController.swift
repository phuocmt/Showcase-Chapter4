...
class ActionViewController: UIViewController {
    ...
    @IBAction func performAction(sender: AnyObject) {
        if actionControl.selectedSegmentIndex == 0 {
            var controller : UIAlertController = UIAlertController(title: "This is an alert", message: "You've created an alert view",
                preferredStyle: UIAlertControllerStyle.Alert);
            var okAction : UIAlertAction = UIAlertAction(title: "Okay", style: UIAlertActionStyle.Default, handler: {
        ...
        {
            var controller: UIAlertController = UIAlertController(title: "This is an action sheet", message: "You've created an action sheet", preferredStyle: UIAlertControllerStyle.ActionSheet);
            var okAction : UIAlertAction = UIAlertAction(title: "Okay", style: UIAlertActionStyle.Default, handler: {
                (alert: UIAlertAction!) in controller.dismissViewControllerAnimated(true, completion: nil)
            })
            controller.addAction(okAction);
